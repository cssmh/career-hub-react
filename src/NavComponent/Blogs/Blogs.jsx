const Blogs = () => {
  return (
    <div>
      <section className="bg-white dark:bg-gray-900 rounded-lg my-4">
      ...
      <div className="mb-8">
        <h1 className="text-xl font-bold mb-3 text-center">Endgame Trailer</h1>
        <div className="flex justify-center">
          <iframe
            width="880"
            height="500"
            src="https://www.youtube.com/embed/TcMBFSGVi1c?si=EuHnNbM1Uw3XwXku"
